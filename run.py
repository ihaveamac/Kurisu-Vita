...
async def on_ready():
    ...
    for server in bot.servers:
        ...
        bot.op_role = discord.utils.get(server.roles, name="Moderator")
        bot.superop_role = discord.utils.get(server.roles, name="Admin")
        bot.owner_role = discord.utils.get(server.roles, name="Owner")
        bot.helpers_role = discord.utils.get(server.roles, name="Helpers")
        bot.ondutyvita_role = discord.utils.get(server.roles, name="On-Duty")
        ...
        bot.staff_ranks = {
            ...
            "Moderator": bot.op_role,
            "Admin": bot.superop_role,
            "Owner": bot.owner_role,
        }

        bot.helper_roles = {
            "Vita": bot.ondutyvita_role,
        }
